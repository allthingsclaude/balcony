...
final class PreferencesManager {
    ...
    /// Locale identifier for secondary voice recognition (empty = disabled).
    var voiceSecondaryLanguage: String {
        UserDefaults.standard.string(forKey: Self.voiceSecondaryLanguageKey) ?? ""
    }
    ...
    func resetAll() {
        let allKeys = [
            ...
            Self.voiceInputEnabledKey, Self.voiceLanguageKey, Self.voiceSecondaryLanguageKey,
